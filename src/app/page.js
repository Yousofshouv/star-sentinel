        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button  onClick={()=>router.push('/introduction')} className="group flex items-center space-x-2 px-4 py-2 rounded-full hover:bg-purple-500/20 transition-all duration-300">
...
<button  onClick={()=>router.push('/Ai')}  className="group flex items-center space-x-2 px-4 py-2 rounded-full hover:bg-purple-500/20 transition-all duration-300">
                <Sparkles className="w-5 h-5 text-yellow-400 group-hover:text-yellow-300 group-hover:animate-pulse" />
                <span className="text-gray-300 group-hover:text-white font-medium">AI Teacher</span>
              </button>
          ...
          <div className={`md:hidden transition-all duration-300 overflow-hidden ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
            <div className="py-4 space-y-4 border-t border-purple-500/30">
              ...
              {/* <a href="#impacts" className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-purple-500/20 transition-all duration-300">
               ...
               <button  onClick={()=>router.push('/introduction')}  className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-purple-500/20 transition-all duration-300">
                ...
                <span className="text-gray-300">Learn</span>
                   ...
                   <button   onClick={()=>router.push('/Ai')} className="flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-purple-500/20 transition-all duration-300">
                <Sparkles className="w-5 h-5 text-purple-400" />
                <span className="text-gray-300">Ai Teacher</span>
              </button>
      ...
      {/* Hero Section */}
      <div id="hero" className="relative min-h-screen flex items-center justify-center px-4 pt-20 z-10">
        {/* Animated Sun */}
    ...
    🛰️
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <button onClick={()=>router.push('/aurora')} className="group bg-transparent border-2 border-cyan-400 hover:bg-cyan-400 hover:text-black px-8 py-4 rounded-full text-xl font-bold transition-all duration-300 flex items-center gap-3">
              ...
              Explore Auroras (Beauty in the beast)
            </button>
          </div>
      ...
      <section id="impacts" className={`py-20 px-4 transition-all duration-1000 relative z-10 ${isVisible.impacts ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <section id="learn" className={`py-20 px-4 bg-gradient-to-r from-purple-900/50 to-indigo-900/50 transition-all duration-1000 relative z-10 ${isVisible.learn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      {/* Footer */}
      <footer className="py-12 px-4 border-t border-purple-500/30 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
